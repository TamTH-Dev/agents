...
This project is indexed by GitNexus as **agents** (17 symbols, 14 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/agents/context` | Codebase overview, check index freshness |
| `gitnexus://repo/agents/clusters` | All functional areas |
| `gitnexus://repo/agents/processes` | All execution flows |
| `gitnexus://repo/agents/process/{name}` | Step-by-step execution trace |
